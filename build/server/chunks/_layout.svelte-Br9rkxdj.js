...
const css = {
  code: ":root{--toastBackground:#efadabec;--toastBarBackground:#ef4444;--toastColor:#123456;--toastPadding:5px 10px 5px 10px;--toastBorderRadius:0.5rem}",
  map: `{"version":3,"file":"+layout.svelte","sources":["+layout.svelte"],"sourcesContent":["<script>\\n\\timport '../app.css';\\n\\n\\timport 'nprogress/nprogress.css';\\n\\timport NProgress from 'nprogress';\\n\\timport { SvelteToast } from '@zerodevx/svelte-toast';\\n\\timport { navigating } from '$app/stores';\\n\\n\\tNProgress.configure({\\n\\t\\tminimum: 0.16\\n\\t});\\n\\n\\t$: {\\n\\t\\tif ($navigating) {\\n\\t\\t\\tNProgress.start();\\n\\t\\t} else {\\n\\t\\t\\tNProgress.done();\\n\\t\\t}\\n\\t}\\n<\/script>\\n\\n<SvelteToast options={{}} />\\n\\n<slot />\\n\\n<style>\\n\\t:root {\\n\\t\\t--toastBackground: #efadabec;\\n\\t\\t--toastBarBackground: #ef4444;\\n\\t\\t--toastColor: #123456;\\n\\t\\t--toastPadding: 5px 10px 5px 10px;\\n\\t\\t--toastBorderRadius: 0.5rem;\\n\\t}\\n</style>\\n"],"names":[],"mappings":"AA0BC,KAAM,CACL,iBAAiB,CAAE,SAAS,CAC5B,oBAAoB,CAAE,OAAO,CAC7B,YAAY,CAAE,OAAO,CACrB,cAAc,CAAE,iBAAiB,CACjC,mBAAmB,CAAE,MACtB"}`
};
...
//# sourceMappingURL=_layout.svelte-Br9rkxdj.js.map
