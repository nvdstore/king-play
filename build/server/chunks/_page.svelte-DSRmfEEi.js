...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  })}</div></div></div></div></main> <aside class="${escape(data.theme.card, true) + " p-4 w-[600px] sticky top-24"}"><div><div class="${"border-b " + escape(data.theme.border, true) + " py-2"}"><span class="text-sm bg-opacity-75" data-svelte-h="svelte-azo7dp">Game:</span> <p class="font-medium">${escape(data.game.name)}</p></div> <div class="${"border-b " + escape(data.theme.border, true) + " py-2"}"><span class="text-sm bg-opacity-75" data-svelte-h="svelte-15ck6km">Produk:</span> <p class="font-medium">${escape("-")}</p></div> <div class="py-2"><span class="text-sm bg-opacity-75" data-svelte-h="svelte-m41bmh">Metode Pembayaran:</span> <p class="font-medium">${escape("-")}</p></div></div></aside></div>`;
});

export { Page as default };
//# sourceMappingURL=_page.svelte-DSRmfEEi.js.map
